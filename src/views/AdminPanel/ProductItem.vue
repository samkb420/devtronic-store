	...
	<div>
		<div class="product-item-wrap emb-card"  >
			<div class="thumb-warp">
				<img alt="product" height="800" width="626" :src="'/static/images/davetronic-logo-blue.jpg'" >
		...
		<emb-delete-confirmation-2
			...
			messageDescription="Are you sure you want to remove this product permanently?"
