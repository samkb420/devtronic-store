<template>
   <div class="emb-FinalReceipt-wrap" v-if="userInfo">
                     ...
                     <div  id="payment-receipt">
                        ...
                        <div class="py-sm-12 py-8 px-sm-6 px-4">
                           <v-layout row wrap mb-6>
                              ...
                              <v-flex xs12 sm6 md6 lg6 xl6>
											<h6>Ship To</h6>
											<p class="mb-1">{{userInfo.firstName}} {{userInfo.lastName}}</p>
											<p class="mb-1">{{userInfo.aptBuilding}}</p>
                                 <p class="mb-1">{{userInfo.cityState}}</p>
                                 <p class="mb-1">{{userInfo.country}} - {{userInfo.zipCode}}</p>
                                 <p class="mb-1">Contact No. {{userInfo.phone}}</p>
                              </v-flex>
                           </v-layout>
