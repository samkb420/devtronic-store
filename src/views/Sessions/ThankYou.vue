                  ...
                  <v-flex xs12 md8 lg6 xl6>
                     <div 
                        class="emb-card pa-6
                           ...
                           text-center"
                     >
                        <h4 class="px-6 pb-2 text-center">For every thing you had done with Davetronic</h4>
                        ...
                        <v-btn block class="accent elevation-5 my-0" height="50">Buy Davetronic Now</v-btn>
                     </div>
                  </v-flex>
               </div>
            </v-flex>
