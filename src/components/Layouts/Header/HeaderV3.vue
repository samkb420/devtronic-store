                  ...
                  <v-container grid-list-xl>
                     <v-layout  row wrap align-center justify-space-between pt-0 pb-0 ma-0 >
                        <v-flex xs6 sm6 md6 lg9 xl9 pa-0 currency-lang-wrap header-v3-top-tools>
                           <span class="white--text">DAVETRONIC COMPANY LTD</span>
                           <a href="/" class="white--text font-weight-regular">Home</a>
                           <a href="/about" class="white--text font-weight-regular">About Us</a>
                           <a href="/contact" class="white--text font-weight-regular">Contact Us</a>
                        </v-flex>
	   ...
	   return{
			...
			userLinks: [
				...
				},
				{
					icon:'settings',
					title:'Settings',
					path:"/account/profile/edit?type=info"
				},
				{	
					icon:'logout',
					title: 'LogOut',
